class Wine < ActiveRecord::Base
  ...
  VARIETALS = ['Albariño', 'Aligoté', 'Amarone', 'Arneis', 'Asti Spumante', 'Auslese', 'Banylus', 'Barbaresco', 'Bardolino', 'Barolo', 'Beaujolais', 'Blanc de Blancs', 'Blanc de Noirs', 'Blush', 'Boal', 'Bordeaux', 'Brunello', 'Cabernet Franc', 'Cabernet Sauvignon', 'Carignan', 'Carmenere', 'Cava', 'Charbono', 'Champagne', 'Chardonnay', 'Châteauneuf-du-Pape', 'Chenin Blanc', 'Chianti', 'Chianti Classico', 'Claret', 'Colombard', 'Constantia', 'Cortese', 'Dolcetto', 'Eiswein', 'Frascati', 'Fumé Blanc', 'Gamay', 'Gamay Beaujolais', 'Gattinara', 'Gewürztraminer', 'Grappa', 'Grenache', 'Johannisberg Riesling', 'Kir', 'Lambrusco', 'Liebfraumilch', 'Madeira', 'Malbec', 'Marc', 'Marsala', 'Marsanne', 'Mead', 'Meritage', 'Merlot', 'Montepulciano', 'Moscato', 'Mourvedre', 'Müller-Thurgau', 'Muscat', 'Nebbiolo', 'Petit Verdot', 'Petite Sirah', 'Pinot Blanc', 'Pinot Grigio/Pinot Gris', 'Pinot Meunier', 'Pinot Noir', 'Pinotage', 'Port', 'Retsina', 'Rosé', 'Roussane', 'Sangiovese', 'Sauterns', 'Sauvignon Blanc', 'Sémillon', 'Sherry', 'Shiraz', 'Soave', 'Tokay', 'Traminer', 'Trebbiano', 'Ugni Blanc', 'Valpolicella', 'Verdicchio', 'Viognier', 'Zinfandel']
